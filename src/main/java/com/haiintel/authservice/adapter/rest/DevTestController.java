...
/**
 * Development/Test controller for testing authentication flow without real Google OAuth.
 * 
 * ⚠️ WARNING: This controller is ONLY enabled in development/local environments.
...
public class DevTestController {
    ...
    @Operation(summary = "[DEV ONLY] Simulate login for testing", 
               description = "Generate JWT token for a test user without real OAuth. FOR DEVELOPMENT ONLY!")
    ...
    @Operation(summary = "[DEV ONLY] Get test user info", 
               description = "Get user info for a test user. FOR DEVELOPMENT ONLY!")
    ...
    @GetMapping("/roles")
    @Operation(summary = "[DEV ONLY] List available roles and groups", 
               description = "List all configured role mappings. FOR DEVELOPMENT ONLY!")
    public ResponseEntity<String> listRoles() {
        return ResponseEntity.ok(
            ...
            "Test examples:\n" +
            "- POST /dev/test/login/steve@haiintel.com?group=admin@haiintel.com\n" +
            "- POST /dev/test/login/john@haiintel.com?group=employees@haiintel.com\n" +
            "- POST /dev/test/login/jane@haiintel.com?group=intern@haiintel.com\n" +
            "- POST /dev/test/login/multi@haiintel.com?group=admin@haiintel.com,employees@haiintel.com"
        );
    }
